        ...
        <div class="h-fit flex flex-col md:flex-row md:justify-center ">
            ...
            <div class="h-fit m-5 bg-gray-100 py-2 rounded-lg w-auto md:w-[160px] drop-shadow-xl">
                <div class="flex justify-between">
                    <div class="flex flex-col">
        ...
        <!-- <div class="flex justify-end px-2 w-fit"> -->
