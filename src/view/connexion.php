      ...
      <div
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" action="index.php?action=LoginTraitement" method="post">
            ...
            <div>
              <label for="password_user" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Votre mot
                de passe</label>
            ...
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
              Pas de compte ? <a href="/apigoogle/src/view/inscription.php"
                class="font-medium text-primary-600 hover:underline dark:text-primary-500">Inscrivez vous</a>
            </p>
          </form>
        </div>
